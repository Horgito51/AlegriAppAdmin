import { dataClient, tables } from "./api/client.js?v=20260615-6";
import { profesoresApi } from "./api/profesoresApi.js?v=20260615-6";
import { cursosApi } from "./api/cursosApi.js?v=20260615-6";
import { materiasApi } from "./api/materiasApi.js?v=20260615-6";
import { createProfesoresModule } from "./modules/profesores.js?v=20260615-6";
import { createCursosModule } from "./modules/cursos.js?v=20260615-6";
import { createMateriasModule } from "./modules/materias.js?v=20260615-6";
import { createAsignacionesModule } from "./modules/asignaciones.js?v=20260615-6";
import { createRepresentantesModule } from "./modules/representantes.js?v=20260615-6";
import { createEstudiantesModule } from "./modules/estudiantes.js?v=20260615-6";
